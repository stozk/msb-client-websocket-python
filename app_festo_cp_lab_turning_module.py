...
if __name__ == "__main__":
    ...
    SO_UUID = "8c2a3a28-eac0-4c5c-a051-fe4431da992d"
    SO_NAME = "Festo CP Lab press module"
    SO_DESCRIPTION = "Raspberry PI 3 + Enviro+ sensor board"
    SO_TOKEN = "fe4431da992d"
    ...
    e_pressing_start = Event("PRESS_START", "Starting pressing", "Pressing process started", DataType.BOOLEAN, 1, False)
    myMsbClient.addEvent(e_pressing_start)

    e_pressing_finished = Event("PRESS_FINISHED", "Pressing finished", "Pressing process finished", DataType.BOOLEAN, 1, False)
    myMsbClient.addEvent(e_pressing_finished)

    f_start_pressing = Function("START_PRESS", "Start pressing", "Starts the pressing process", DataType.BOOLEAN, startPressing, False, ["PRESS_START"])
    myMsbClient.addFunction(f_start_pressing)
