...
if __name__ == "__main__":
    ...
    e_pressing_start = Event(
        "START_PRESS",
        "Start pressing process",
        "Triggers pressing process",
        DataType.BOOLEAN,
        1,
        False,
    )
    ...
    e_pressing_finished = Event(
        "START_TURNING",
        "Start turning process",
        "Triggers turning process",
        DataType.BOOLEAN,
        1,
        False,
    )
    ...
    f_process_ack = Function(
        "PROCESS_RESULT",
        "Acknowledge process result",
        "Acknowledge process result",
        DataType.BOOLEAN,
        ackResult,
        False,
