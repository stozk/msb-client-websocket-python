...
if __name__ == "__main__":
    ...
    SO_UUID = "30471b36-0938-4833-8a74-14a35ddec26d"
    SO_NAME = "Festo CP Lab MES service"
    SO_DESCRIPTION = "Raspberry PI 3 + Enviro+ sensor board"
    SO_TOKEN = "14a35ddec26d"
    ...
    e_pressing_start = Event("START_PRESS", "Start pressing process", "Triggers pressing process", DataType.BOOLEAN, 1, False)
    myMsbClient.addEvent(e_pressing_start)

    e_pressing_finished = Event("START_TURNING", "Start turning process", "Triggers turning process", DataType.BOOLEAN, 1, False)
    myMsbClient.addEvent(e_pressing_finished)

    f_process_ack = Function("PROCESS_RESULT", "Acknowledge process result", "Acknowledge process result", DataType.BOOLEAN, ackResult, False, [])
    myMsbClient.addFunction(f_process_ack)
