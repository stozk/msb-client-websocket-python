...
if __name__ == "__main__":
    ...
    SO_UUID = "10ab79a4-bda3-434c-b8bc-be91e1f43d53"
    SO_NAME = "Festo CP Lab turning module"
    SO_DESCRIPTION = "Raspberry PI 3 + Enviro+ sensor board"
    SO_TOKEN = "be91e1f43d53"
    ...
    e_turning_start = Event("TURNING_START", "Starting turning", "Turning process started", DataType.BOOLEAN, 1, False)
    myMsbClient.addEvent(e_turning_start)

    e_turning_finished = Event("TURNING_FINISHED", "Turning finished", "Turning process finished", DataType.BOOLEAN, 1, False)
    myMsbClient.addEvent(e_turning_finished)

    f_start_turning = Function("START_TURNING", "Start turning", "Starts the turning process", DataType.BOOLEAN, startTurning, False, ["TURNING_START"])
    myMsbClient.addFunction(f_start_turning)
