...
if __name__ == "__main__":
    ...
    SO_UUID = "78ed0598-17a7-448c-877a-50da8dcfedf6"
    SO_NAME = "Grafana Dashboard"
    SO_DESCRIPTION = "Raspberry PI 3 + Enviro+ sensor board"
    SO_TOKEN = "50da8dcfedf6"
    ...
    f_store_data = Function("STORE_DATA", "Store Data", "Stores Data to the Database", DataType.STRING, startReadFineParticle, False, [])

    myMsbClient.addFunction(f_store_data)
