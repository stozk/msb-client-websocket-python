...
if __name__ == "__main__":
    ...
    SO_UUID = "691c9fb2-5a4b-43bc-a0a8-9e0cefb59933"
    SO_NAME = "Flow Test Service 2"
    SO_DESCRIPTION = "Flow Test Service 2"
    SO_TOKEN = "9e0cefb59933"
    ...
    def printMsg(msg):
        ...
        myMsbClient.publish("RESPONSE_INFO_MESSAGE", "Response Message with payload: " + str(msg["dataObject"]), 1, False, None, "9c8b8d10-a97f-459b-8e6b-e63330425614")
    ...
    def send_data():
        ...
        myMsbClient.publish("RESPONSE_INFO_MESSAGE", "Message from service 2", 1, False, None, "9c8b8d10-a97f-459b-8e6b-e63330425614")
